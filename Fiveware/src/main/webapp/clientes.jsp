		...
		<div class="contGeneral">
			...
			<nav class="nav">
				<ul>
					...
					<li class="boton_nav" ><a class="select" href="controlador?menu=Clientes&accion=Listar"><p class="texto_nav">Clientes</p></a></li>
		...
		<div style="width: 300px; float: left;">
			...
			<form class="form-sign" method="get" action="controlador">
				...
				<div class="contenedorbtn">
					...
					<input type="submit" class="btn BtnForm" name="accion" value="Buscar">
				</div>
			</form>
